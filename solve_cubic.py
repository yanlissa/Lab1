...
def print_help():
    ...
    print("Вывод: действительные корни в одной строке, разделенные пробелами. Целые числа без десятичной части, нецелые — с точностью до 3 знаков. Если корней нет, выводится 'x ∈ ∅'. В транзитивном случае выводит 'x ∈ ℝ'")
